...
copyright = f"2010 - {date.today().year}, {openpyxl.__author__}"
...
latex_documents = [
    ("index", "openpyxl.tex", "openpyxl Documentation", openpyxl.__author__, "manual"),
]
...
man_pages = [("index", "openpyxl", "openpyxl Documentation", [openpyxl.__author__], 1)]
