...
class NumVal(Serialisable):
    ...
    def __init__(self, idx=None, formatCode=None, v=None):
        self.idx = idx
        self.formatCode = formatCode
        self.v = v
...
class NumData(Serialisable):
    ...
    def __init__(self, formatCode=None, ptCount=None, pt=(), extLst=None):
        self.formatCode = formatCode
...
class NumRef(Serialisable):
    ...
    def __init__(self, f=None, numCache=None, extLst=None):
        self.f = f
...
class StrData(Serialisable):
    ...
    def __init__(self, ptCount=None, pt=(), extLst=None):
        self.ptCount = ptCount
        self.pt = pt
...
class StrRef(Serialisable):
    ...
    def __init__(self, f=None, strCache=None, extLst=None):
        self.f = f
...
class NumDataSource(Serialisable):
    ...
    def __init__(self, numRef=None, numLit=None):
        self.numRef = numRef
        self.numLit = numLit
...
class MultiLevelStrData(Serialisable):
    ...
    def __init__(self, ptCount=None, lvl=(), extLst=None):
        self.ptCount = ptCount
        self.lvl = lvl
...
class MultiLevelStrRef(Serialisable):
    ...
    def __init__(self, f=None, multiLvlStrCache=None, extLst=None):
        self.f = f
