...
class TestCustomDocumentProperty:
    ...
    def test_from_xml(self, CustomDocumentProperty):
        ...
        assert (
            prop.filetime
            == datetime.datetime(2020, 8, 24, hour=20, minute=19, second=22)
            and prop.name == "PropName1"
        )
...
class TestCustomDocumentProperyList:
    ...
    def test_ctor(self, CustomDocumentPropertyList, CustomDocumentProperty):
        ...
        prop1 = CustomDocumentProperty(
            name="PropName1", filetime=datetime.datetime(2020, 8, 24, 20, 19, 22)
        )
        prop2 = CustomDocumentProperty(
            name="PropName2", linkTarget="ExampleName", lpwstr=""
        )
...
class TestTypedPropertyList:
    ...
    def test_repr(self, CustomPropertyList):
        ...
        assert (
            repr(prop_list)
            == "CustomPropertyList containing [StringProperty, name=PropName1, value=Something]"
        )
    ...
    def test_datetime(self, CustomPropertyList):
        prop = DateTimeProperty(
            name="PropName1", value=datetime.datetime(2022, 5, 31, 12, 55, 13)
        )
        prop_list = CustomPropertyList()
        prop_list.append(prop)
    ...
    def test_from_datetime(self, CustomPropertyList):
        ...
        assert new_props.props[0] == DateTimeProperty(
            name="PropName1", value=datetime.datetime(2022, 5, 31, 12, 55, 13)
        )
