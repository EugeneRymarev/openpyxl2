...
def test_split_into_parts():
    ...
    s = '&L&"Lucida Grande,Standard"&K000000Left top&C&"Lucida Grande,Standard"&K000000Middle top&R&"Lucida Grande,Standard"&K000000Right top'
...
class TestHeaderFooterItem:
    ...
    def test_read(self, HeaderFooterItem):
        xml = '<oddHeader>&amp;L&amp;"Lucida Grande,Standard"&amp;K000000&amp;12 Left top&amp;C&amp;"Lucida Grande,Standard"&amp;K000000Middle top&amp;R&amp;"Lucida Grande,Standard"&amp;K000000Right top</oddHeader>'
        node = fromstring(xml)
