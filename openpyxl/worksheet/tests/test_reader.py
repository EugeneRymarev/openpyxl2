...
def work_sheet_parser():
    ...
    date_formats = {1, 29, 30}
    timedelta_formats = {30}
...
class TestWorksheetParser:
    ...
    def test_read_dimension(self, work_sheet_parser, datadir, filename, expected):
        datadir.chdir()
        parser = work_sheet_parser
        parser.source = filename
        dimension = parser.parse_dimensions()
        assert dimension == expected

    def test_col_width(self, datadir, work_sheet_parser):
        datadir.chdir()
        parser = work_sheet_parser
        ...
        assert set(parser.column_dimensions) == {"A", "C", "E", "I", "G"}
        expected = {
            "max": "1",
            "min": "1",
            "index": "A",
        ...
        assert parser.column_dimensions["A"] == expected

    def test_hidden_col(self, work_sheet_parser):
        parser = work_sheet_parser
        ...
        assert parser.column_dimensions["D"] == expected

    def test_styled_col(self, datadir, work_sheet_parser):
        datadir.chdir()
        parser = work_sheet_parser
        with open("complex-styles-worksheet.xml", "rb") as src:
            cols = iterparse(src, tag=f"{{{SHEET_MAIN_NS}}}col")
    ...
    def test_row_dimensions(self, work_sheet_parser):
    ...
    def test_hidden_row(self, work_sheet_parser):
        parser = work_sheet_parser
    ...
    def test_styled_row(self, datadir, work_sheet_parser):
        parser = work_sheet_parser
    ...
    def test_read_row_with_exponent(self, work_sheet_parser):
        parser = work_sheet_parser
    ...
    def test_invalid_row_number(self, work_sheet_parser):
        parser = work_sheet_parser
    ...
    def test_sheet_protection(self, datadir, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <sheetProtection
        ...
        assert dict(parser.protection) == expected

    def test_formula(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <c r="A1"
           t="str"
    ...
    def test_formula_data_only(self, work_sheet_parser):
        parser = work_sheet_parser
    ...
    def test_string_formula_data_only(self, work_sheet_parser):
        parser = work_sheet_parser
        parser.data_only = True
        src = """
        <c r="A1"
    ...
    def test_number(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <c r="A1" xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <v>1</v>
    ...
    def test_datetime(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <c r="A1"
           t="d"
    ...
    def test_timedelta(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <c r="A1"
           t="n"
    ...
    def test_mac_date(self, work_sheet_parser):
        parser = work_sheet_parser
    ...
    def test_out_of_range_datetime(self, work_sheet_parser, recwarn, value):
        parser = work_sheet_parser
        src = f"""
        <c r="A1"
           t="n"
    ...
    def test_string(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <c r="A1"
           t="s"
    ...
    def test_boolean(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <c r="A1"
           t="b"
    ...
    def test_inline_string(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
    ...
    def test_inline_richtext(self, work_sheet_parser):
        parser = work_sheet_parser
    ...
    def test_parse_richtext(self):
        from openpyxl.worksheet._reader import parse_richtext_string
    ...
    def test_sheet_views(self, work_sheet_parser):
        parser = work_sheet_parser
        src = b"""
    ...
    def test_shared_formula(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <c r="A9"
           t="str"
    ...
    def test_array_formula(self, work_sheet_parser, datadir):
        parser = work_sheet_parser
        src = """
    ...
    def test_table_formula(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
    ...
    def test_extended_conditional_formatting(self, work_sheet_parser, recwarn):
        parser = work_sheet_parser
        src = """
        <extLst>
                ...
                <x14:conditionalFormattings>
                    <x14:conditionalFormatting
                        ...
                        <x14:cfRule
                                ...
                                id="{5F3BF262-1B4E-49BC-812D-8F5B1802CE0A}">
    ...
    def test_bad_conditional_format_rule(self, work_sheet_parser, recwarn):
        parser = work_sheet_parser
        src = """
    ...
    def test_cell_without_coordinates(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
    ...
    def test_row_and_cell_without_coordinates(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
    ...
    def test_row_and_cell_skipping_coordinates(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <row xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <c>
    ...
    def test_second_row_cell_index_without_coordinates(self, work_sheet_parser):
        parser = work_sheet_parser
        src = """
        <row xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <c>
    ...
    def test_external_hyperlinks(self, work_sheet_parser):
        src = b"""
    ...
    def test_local_hyperlinks(self, work_sheet_parser):
        src = b"""
        <hyperlinks xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <hyperlink
                    ref="B4:B7"
                    location="'STP nn000TL-10, PKG 2.52'!A1"
                    display="STP 10000TL-10"/>
        </hyperlinks>
        """
        parser = work_sheet_parser
        parser.source = io.BytesIO(src)
    ...
    def test_merge_cells(self, work_sheet_parser):
        src = b"""
    ...
    def test_conditional_formatting(self, work_sheet_parser):
        src = b"""
        <sheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
    ...
    def test_sheet_properties(self, work_sheet_parser):
        src = b"""
        <sheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
    ...
    def test_sheet_format(self, work_sheet_parser):
        src = b"""
        <sheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
    ...
    def test_tables(self, work_sheet_parser):
        src = b"""
        <tableParts
                count="1"
                xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
    ...
    def test_auto_filter(self, work_sheet_parser):
        src = b"""
        <sheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
    ...
    def test_page_row_break(self, work_sheet_parser):
        src = b"""
        <rowBreaks
                count="1"
                manualBreakCount="1"
    ...
    def test_col_break(self, work_sheet_parser):
        src = b"""
        <colBreaks
                count="1"
                manualBreakCount="1"
    ...
    def test_scenarios(self, work_sheet_parser):
        src = b"""
        <sheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
    ...
    def test_legacy(self, work_sheet_parser):
        src = """
        <legacyDrawing
                r:id="rId3"
                xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
    ...
    def test_custom_views_breaks(self, work_sheet_parser):
        src = b"""
        <sheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            <customSheetViews>
...
@pytest.fixture
def primed_worksheet_reader(workbook, worksheet_reader, datadir):
    wb = workbook
    ws = wb.create_sheet("Sheet")
    datadir.chdir()
    src = "complex-styles-worksheet.xml"
    reader = worksheet_reader(
        ws,
        src,
        wb.shared_strings,
        data_only=False,
...
class TestWorksheetReader:
    def test_cell(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
        assert ws["C1"].value == "a"

    def test_array_formula(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
        assert ws["E2"].value.text == "=C2:C11*D2:D11"

    def test_formatting(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
    ...
    def test_merged(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
    ...
    def test_external_hyperlinks(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
    ...
    def test_internal_hyperlinks(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
        r = Relationship(type="hyperlink", Id="rId1", Target="../")
    ...
    def test_merged_hyperlinks(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
        r = Relationship(type="hyperlink", Id="rId1", Target="../")
    ...
    def test_tables(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
    ...
    def test_cols(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
    ...
    def test_rows(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
    ...
    def test_properties(self, primed_worksheet_reader):
        reader = primed_worksheet_reader
        reader.bind_cells()
        ws = reader.ws
    ...
    def test_more_rows_than_cells(self, workbook, worksheet_reader, datadir):
        ws = workbook.create_sheet("Sheet")
        datadir.chdir()
        reader = worksheet_reader(ws, "more_rows_than_cells.xml", None, None, False)
        reader.bind_cells()
