...
class WorksheetCopy:
    ...
    def _verify_resources(self):
        condition1 = not isinstance(self.source, Worksheet)
        condition2 = not isinstance(self.target, Worksheet)
    ...
    def copy_worksheet(self):
        ...
        self.target.merged_cells = copy.copy(self.source.merged_cells)
