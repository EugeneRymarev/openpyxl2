...
class TestTokenizer:
    ...
    def test_parse(self, tokenizer, formula, tokens):
        ...
        result = [(token.value, token.type, token.subtype) for token in tok.items]
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "123'sextuple '''''' and septuple''''''' and more",
                3,
                "'sextuple '''''' and septuple'''''''",
            ),
            ("''", 0, "''"),
    ...
    @pytest.mark.parametrize(
        "formula, offset, opener, type_, subtype",
        [
