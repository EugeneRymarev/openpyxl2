...
class TestCellRichText:
    ...
    def test_str(self):
        b1 = TextBlock(font=InlineFont(b=True), text="Mary ")
        b2 = TextBlock(InlineFont(i=True), text="lamb")
        text = CellRichText(b1, "had ", "a little ", b2)
    ...
    def test_inline(self):
        ...
        expected = CellRichText(TextBlock(InlineFont(sz=8), "11 de September de 2014"))
        assert rt == expected
    ...
    def test_opt_text(self):
        ...
        text = CellRichText(b1, "had ", "a little ", b2)
        text._opt()
        assert text == CellRichText(b1, "had a little ", b2)
    ...
    def test_opt_textblock(self):
        b1 = TextBlock(font=InlineFont(b=True), text="Mary ")
        b2 = TextBlock(font=InlineFont(b=True), text="had ")
        b3 = TextBlock(InlineFont(i=True), text="lamb")
        b4 = TextBlock(font=InlineFont(b=True), text="Mary had ")
        text = CellRichText(b1, b2, "a little ", b3)
        text._opt()
        assert text == CellRichText(b4, "a little ", b3)

    def test_opt_empty_textblock(self):
        b1 = TextBlock(font=InlineFont(b=True), text="Mary had ")
        b2 = TextBlock(font=InlineFont(b=True), text="")
        b3 = TextBlock(InlineFont(i=True), text="lamb")
        text = CellRichText(b1, b2, "a little ", b3)
        text._opt()
        assert text == CellRichText(b1, "a little ", b3)

    def test_opt_empty_different_textblock_after(self):
        b1 = TextBlock(font=InlineFont(b=True), text="Mary had ")
        b2 = TextBlock(font=InlineFont(i=True), text="")
        b3 = TextBlock(InlineFont(i=True), text="lamb")
        text = CellRichText(b1, b2, "a little ", b3)
        text._opt()
        assert text == CellRichText(b1, "a little ", b3)
    ...
    def test_opt_empty_different_textblock_before(self):
        b1 = TextBlock(font=InlineFont(i=True), text="")
        b2 = TextBlock(font=InlineFont(b=True), text="Mary had ")
        b3 = TextBlock(InlineFont(i=True), text="lamb")
        text = CellRichText(b1, b2, "a little ", b3)
        text._opt()
        assert text == CellRichText(b2, "a little ", b3)

    def test_add(self):
        b = TextBlock(InlineFont(sz=8), "11 de September de 2014")
        rt1 = CellRichText(b)
        rt2 = rt1 + "un bon jour"
        assert rt2 == CellRichText(b, "un bon jour")

    def test_setitem(self):
        b = TextBlock(InlineFont(sz=8), "11 de September de 2014")
        rt = CellRichText(b, "un bon jour")
        rt[1] = "sera"
        assert rt == CellRichText(b, "sera")
