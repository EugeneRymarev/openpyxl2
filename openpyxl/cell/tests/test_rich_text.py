...
class TestCellRichText:
    ...
    def test_rich_text_from_element_rich_text_only_text_block(self):
        node = fromstring(
            '<si><r><rPr><b/><sz val="11"/><color theme="1"/><rFont val="Calibri"/><family val="2"/><scheme val="minor"/></rPr><t>c</t></r></si>'
        )
        text = CellRichText.from_tree(node)
    ...
    def test_rich_text_from_element_rich_text_mixed(self):
        node = fromstring(
            '<si><r><t>a</t></r><r><rPr><b/><sz val="11"/><color theme="1"/><rFont val="Calibri"/><family val="2"/><scheme val="minor"/></rPr><t>c</t></r><r><t>e</t></r></si>'
        )
        text = CellRichText.from_tree(node)
        assert text == CellRichText(
            "a",
    ...
    def test_inline(self):
        ...
        assert rt == CellRichText(
            TextBlock(InlineFont(sz=8), "11 de September de 2014")
        )
    ...
    def test_add(self):
        ...
        rt2 = rt1 + "un bon jour"
        assert rt2 == CellRichText(
            TextBlock(InlineFont(sz=8), "11 de September de 2014"), "un bon jour"
        )
    ...
    def test_setitem(self):
        ...
        rt[1] = "sera"
        assert rt == CellRichText(
            TextBlock(InlineFont(sz=8), "11 de September de 2014"), "sera"
        )
